...
class MartyControllerApp(QWidget):
    ...
    def initUI(self):
        ...
        self.ip_entry.setText('192.168.0.102')  # Adresse IP par défaut
    ...
    def connect_to_marty(self):
        ...
        try:
            ...
            if self.marty.is_connected():
                QMessageBox.information(self, "Connexion réussie", "Connexion à Marty réussie !")
            else:
                QMessageBox.warning(self, "Erreur de connexion", "Impossible de se connecter à Marty.")
